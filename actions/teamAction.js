                                ...
                                AsyncStorage.getItem("lastMessageId").then(res => {
                                    if (res) {
                                        ...
                                        if(lastObj){
                                            ...
                                            dispatch(manageAppBadgeCount(response.data.length));
                                            if (AppConstant.isIOS) {
                                                PushNotificationIOS.setApplicationIconBadgeNumber(response.data.length + getState().team.eventBadgeCount);
                                            }
                                        }
                                    }
...
export const getleaderboardIndividualList = (isFromLogin = false) => {
    return (dispatch, getState) => {
        return CallApi(Constant.baseUrlV2 + Constant.leaderBoardIndividual, 'get', {}, {"Authorization": "Bearer " + getState().user.token})
            .then((response) => {
                if (!isFromLogin) {
...
export const getLeaderBoardIndividualYear = () => {
    return (dispatch, getState) => {
        return CallApi(Constant.baseUrlV2 + Constant.leaderBoardIndividualYear, 'get', {}, {"Authorization": "Bearer " + getState().user.token})
            .then((response) => {
                dispatch({
                    type: INDIVIDUAL_LEADER_BOARD,
                    payload: {
...
export const getLeaderBoardIndividualMonth = () => {
    return (dispatch, getState) => {
        return CallApi(Constant.baseUrlV2 + Constant.leaderBoardIndividualMonth, 'get', {}, {"Authorization": "Bearer " + getState().user.token})
            .then((response) => {
                dispatch({
                    type: INDIVIDUAL_LEADER_BOARD,
                    payload: {
...
export const getLeaderBoardIndividualWeek = () => {
    return (dispatch, getState) => {
        return CallApi(Constant.baseUrlV2 + Constant.leaderBoardIndividualWeek, 'get', {}, {"Authorization": "Bearer " + getState().user.token})
            .then((response) => {
                dispatch({
                    type: INDIVIDUAL_LEADER_BOARD,
                    payload: {
...
export const getLeaderBoardIndividualBestStreak = () => {
    return (dispatch, getState) => {
        return CallApi(Constant.baseUrlV2 + Constant.leaderBoardIndividualBestStreak, 'get', {}, {"Authorization": "Bearer " + getState().user.token})
            .then((response) => {
                return dispatch({
                    type: INDIVIDUAL_LEADER_BOARD,
                    payload: {
...
export const getLeaderBoardIndividualCurrentStreak = () => {
    return (dispatch, getState) => {
        return CallApi(Constant.baseUrlV2 + Constant.leaderBoardIndividualCurrentStreak, 'get', {}, {"Authorization": "Bearer " + getState().user.token})
            .then((response) => {
                return dispatch({
                    type: INDIVIDUAL_LEADER_BOARD,
                    payload: {
...
export const getLeaderBoardIndividualAmerica = () => {
    return (dispatch, getState) => {
        return CallApi(Constant.baseUrlV2 + Constant.leaderBoardIndividualAmerica, 'get', {}, {"Authorization": "Bearer " + getState().user.token})
            .then((response) => {
                dispatch({
                    type: INDIVIDUAL_LEADER_BOARD,
                    payload: {
...
export const getLeaderBoardIndividualAsia = () => {
    return (dispatch, getState) => {
        return CallApi(Constant.baseUrlV2 + Constant.leaderBoardIndividualAsia, 'get', {}, {"Authorization": "Bearer " + getState().user.token})
            .then((response) => {
                dispatch({
                    type: INDIVIDUAL_LEADER_BOARD,
                    payload: {
...
export const getLeaderBoardIndividualEurope = () => {
    return (dispatch, getState) => {
        return CallApi(Constant.baseUrlV2 + Constant.leaderBoardIndividualEurope, 'get', {}, {"Authorization": "Bearer " + getState().user.token})
            .then((response) => {
                dispatch({
                    type: INDIVIDUAL_LEADER_BOARD,
                    payload: {
...
export const getLeaderBoardIndividualPacific = () => {
    return (dispatch, getState) => {
        return CallApi(Constant.baseUrlV2 + Constant.leaderBoardIndividualPacific, 'get', {}, {"Authorization": "Bearer " + getState().user.token})
            .then((response) => {
                dispatch({
                    type: INDIVIDUAL_LEADER_BOARD,
                    payload: {
...
export const getleaderboardTeamList = (isFromLogin = false) => {
    return (dispatch, getState) => {
        return CallApi(Constant.baseUrlV2 + Constant.leaderBoardTeamOverall, 'get', {}, {"Authorization": "Bearer " + getState().user.token})
            .then((response) => {
                if (!isFromLogin) {
...
export const getLeaderBoardTeamYear = () => {
    return (dispatch, getState) => {
        return CallApi(Constant.baseUrlV2 + Constant.leaderBoardTeamYear, 'get', {}, {"Authorization": "Bearer " + getState().user.token})
            .then((response) => {
                dispatch({
                    type: TEAM_LEADER_BOARD,
                    payload: {
...
export const getLeaderBoardTeamMonth = () => {
    return (dispatch, getState) => {
        return CallApi(Constant.baseUrlV2 + Constant.leaderBoardTeamMonth, 'get', {}, {"Authorization": "Bearer " + getState().user.token})
            .then((response) => {
                dispatch({
                    type: TEAM_LEADER_BOARD,
                    payload: {
...
export const getLeaderBoardTeamWeek = () => {
    return (dispatch, getState) => {
        return CallApi(Constant.baseUrlV2 + Constant.leaderBoardTeamWeek, 'get', {}, {"Authorization": "Bearer " + getState().user.token})
            .then((response) => {
                dispatch({
                    type: TEAM_LEADER_BOARD,
                    payload: {
