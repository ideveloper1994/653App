...
import { addHelpComment, getCommentByPostId, likeHelpPostComment,
    unlikeHelpPostComment, editHelpComment,getHelpPostDetailById } from '../../../../../../actions/helpPostActions';
import {
...
class PostComment extends Component {
    ...
    constructor(props){
        super(props);
        this.state={
            helpPostData: props.navigation.state.params.rowData || null,
            modalVisible: false,
            isEdit: false,
            editData: {},
            isCommentEdit: false,
    ...
    componentDidMount(){
        if(this.props.navigation.state && this.props.navigation.state.params.postId){
            this.props.getHelpPostDetailById(this.props.navigation.state.params.postId).then(res => {
                if(res){
                    this.setState({
                        helpPostData: res
                    })
    ...
    renderHeader = () => {
        if(this.state.helpPostData && this.state.helpPostData.content){
            return(<CommentTitle content={this.state.helpPostData.content}
        ...
        return (
            <View style={[container,{paddingBottom: this.props.safeAreaInsetsData.bottom, backgroundColor:appColor.commentViewBack}]}>
                <NavigationBar onBackButtonPress={ this.onBackButtonPress }
                               ...
                               isRightButton={false}/>
                {
                    this.state.helpPostData == null &&
                    <View style={[styles.container, {
                        backgroundColor: appColor.textInputBackColor,
