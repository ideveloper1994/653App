            ...
            <View style={[container, {backgroundColor: this.props.isHighlited && appColor.teamDetailsRow || Constant.transparent}]}>
                ...
                <View style={{flex: 1}}>
                    ...
                    <View style={{
                        ...
                        <TouchableHighlight underlayColor={Constant.transparent}
                            ...
                            <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                ...
                                <Text style={[textName, {color: appColor.postAdviceRowBottomText}]}>
                                    {creator && (creator.is_current_user && "You" || creator.name) || ""}
                                </Text>
                            </View>
                        </TouchableHighlight>
                        {
                            (porn_free_days !== null) &&
                            <View
                                style={[styles.totalPornDayView, {backgroundColor: appColor.comunityPornDayCount}]}>
                        ...
                        {
                            (creator && creator.is_current_user) &&
