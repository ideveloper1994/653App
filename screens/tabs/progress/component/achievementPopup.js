...
import AchievementIcon from '../subComponent/achievementIcon';
import ProgressBar from '../../../commonComponent/progressBar';
import * as Animatable from 'react-native-animatable';

export default  class AchievementPopUp extends React.PureComponent {
        ...
        return(
            <View style={styles.outerView}>
                ...
                <Animated.View style={[styles.innerPopupView,{transform: [{translateY: this.offset}]}]}>
                    <AchievementIcon objIcon={this.props.selectedData}
