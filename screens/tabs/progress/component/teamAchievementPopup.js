...
import AchievementIcon from '../../team/component/teamAchivementIcon';
import ProgressBar from '../../../commonComponent/progressBar';
import * as Animatable from 'react-native-animatable';

export default  class TeamAchievementPopUp extends React.PureComponent {
        ...
        return(
            <View style={styles.outerView}>
                ...
                <Animated.View style={[styles.innerPopupView,{transform: [{translateY: this.offset}]}]}>
                    <AchievementIcon objIcon={this.props.selectedData.objIcon}
                    ...
                    <Text style={styles.bottomTitle}>
                        {this.props.selectedData.remainingProgress}
                    </Text>
                </Animated.View>
                {
