...
import StatisticStackNavigator from '../screens/tabs/statistics/statisticsTab';
...
class rootTabNavigation extends React.Component {
    ...
    render() {
        ...
        return (
            <View style={[styles.container,{backgroundColor: appColor.tabbarBack}]}>
...
const styles = StyleSheet.create({
    container: {
        ...
        height: Constant.screenHeight,marginTop:0,
        overflow: 'hidden'
    },
    tabBar: {
